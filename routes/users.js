...
user_savedPoints_db = {"u1":{"savedPoints": [1,3,5]}};
...
/*  Get - getUserTwoSavedPointsID   */
router.get('/getUserTwoSavedPointsID/:uName', function(req, res, next) {
    var params = req.params;
    var userName = params.uName;
...
/*  Get - getUserAllSavedPointsID   */
router.get('/getUserAllSavedPointsID/:uName', function(req, res, next) {
    var params = req.params;
    var userName = params.uName;
